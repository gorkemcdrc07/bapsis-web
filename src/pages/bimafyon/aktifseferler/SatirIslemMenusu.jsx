                        ...
                        <div style={{ padding: "16px 20px 20px" }}>
                            ...
                            <div style={{ marginBottom: 16 }}>
                                ...
                                >
                                    ...
                                    {vknOptions.map((vkn) => (
                                        <option key={vkn} value={vkn}>{vkn}</option>
                                    ))}
                                </select>
                            </div>
                            ...
                            {selectedActionRow?.cekici && (
                                <div style={{
                                    ...
                                    <div>
                                        <div style={{ fontSize: 11, color: "#9ca3af" }}>Çekici</div>
                                    ...
                                    {selectedActionRow.vkn && (
                                        <>
                                            <div style={{ width: "0.5px", height: 28, background: "#e5e7eb", margin: "0 4px" }} />
                                            <div>
                                                <div style={{ fontSize: 11, color: "#9ca3af" }}>Mevcut VKN</div>
                                                <div style={{ fontSize: 13, fontWeight: 700, color: "#0f172a" }}>
                                                    {selectedActionRow.vkn}
                                                </div>
                                            </div>
