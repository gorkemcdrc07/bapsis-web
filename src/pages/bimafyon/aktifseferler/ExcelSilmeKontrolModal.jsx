        ...
        <div className="modal-overlay">
            <div className="modern-panel revision-panel">
                <div className="modal-header">
                    ...
                    <button className="modal-close" onClick={() => setDeletedTripPrompt(null)}>
                        ×
                    </button>
                </div>
                    ...
                    {deletedTripPrompt.rows.map((row) => (
                        <div className="revision-card" key={row.id}>
                            <div className="revision-card-head">
                                ...
                                <span>{row.seferNo || "Sefer No yok"} · {row.cekici || "Plaka yok"}</span>
                            </div>

                            <small>
                                {row.surucu || "Sürücü yok"} / {row.varis1 || "Varış yok"} / {row.aracDurumu || "Durum yok"}
                            </small>
                        </div>
                    ))}
                </div>
                ...
                <div className="complete-actions">
                    <button className="ghost-btn" onClick={() => setDeletedTripPrompt(null)}>
                        Hayır, Silme
                    </button>
