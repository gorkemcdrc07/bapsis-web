...
export async function saveCompletedTripArchive(row, reason = "Sefer tamamlandı") {
...
export async function saveDeletedTripArchive(row, reason = "Excel listesinde olmadığı için silindi") {
    const aktifKullanici = getAktifKullanici();
    ...
    if (error) {
        alert(`Silinen sefer arşive kaydedilemedi: ${error.message}`);
        return false;
    }
