    ...
    return (
        <div className="planlama-page">
            ...
            <section className="plan-layout">
                <div className="main-card"><div className="card-head"><span className="step-num">01</span><div><h2>Dosyaları Yükle</h2><p>Ana veri ve talep Excel dosyalarını seçin.</p></div></div><div className="upload-grid"><UploadBox title="Veri Dosyası" description="Depolar, araçlar, mesafeler, tarifeler." file={dataFile} onChange={(f) => { setDataFile(f); setError(""); setMessage("Veri dosyası yüklendi."); }} /><UploadBox title="Talep Dosyası" description="'Demands' sayfası içeren talep dosyası." file={demandFile} onChange={handleDemandFile} /></div></div>
            ...
            <section className="run-card"><div><h3>Planlamayı Başlat</h3><p>Tüm seçimler tamamlandığında çalıştırabilirsiniz.</p></div><button type="button" disabled={!canRun} onClick={handleRun}>{loading ? "Hesaplanıyor…" : "Planlamayı Çalıştır →"}</button></section>
