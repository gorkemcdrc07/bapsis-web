                ...
                {!completeDetailRow ? (
                    <>
                        <div className="complete-content">
                            ...
                            <strong>Seferi tamamlamak ister misin?</strong>
                            <p>
                                Zorunlu alanlar tamamlandı. Detayları kontrol edip seferi tamamlayabilirsin.
                            </p>
                        </div>
                    ...
                    <>
                        ...
                        <div className="completion-detail-grid">
                            ...
                            <div><small>Dataloger</small><b>{completeDetailRow.datalogerNo || "—"}</b></div>
